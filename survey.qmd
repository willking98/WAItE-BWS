...
<!-- |-------------------|-----------------------------------------------------------| -->
<!-- | **Tiredness**      | I **never** get tired.                                   | -->
<!-- |                   | I **almost never** get tired.                            | -->
<!-- |                   | I **sometimes** get tired.                               | -->
<!-- |                   | I **often** get tired.                                   | -->
<!-- |                   | I **always** get tired.                                  | -->
<!-- | **Walking**        | I **never** struggle to keep up when walking.            | -->
<!-- |                   | I **almost never** struggle to keep up when walking.     | -->
<!-- |                   | I **sometimes** struggle to keep up when walking.        | -->
<!-- |                   | I **often** struggle to keep up when walking.            | -->
<!-- |                   | I **always** struggle to keep up when walking.           | -->
<!-- | **Sports**         | I **never** avoid doing sports.                          | -->
<!-- |                   | I **almost never** avoid doing sports.                   | -->
<!-- |                   | I **sometimes** avoid doing sports.                      | -->
<!-- |                   | I **often** avoid doing sports.                          | -->
<!-- |                   | I **always** avoid doing sports.                         | -->
<!-- | **Concentration**  | I **never** struggle to concentrate.                     | -->
<!-- |                   | I **almost never** struggle to concentrate.              | -->
<!-- |                   | I **sometimes** struggle to concentrate.                 | -->
<!-- |                   | I **often** struggle to concentrate.                     | -->
<!-- |                   | I **always** struggle to concentrate.                    | -->
<!-- | **Embarrassment**  | I **never** feel embarrassed shopping.                   | -->
<!-- |                   | I **almost never** feel embarrassed shopping.            | -->
<!-- |                   | I **sometimes** feel embarrassed shopping.               | -->
<!-- |                   | I **often** feel embarrassed shopping.                   | -->
<!-- |                   | I **always** feel embarrassed shopping.                  | -->
<!-- | **Unhappiness**    | I **never** feel unhappy because of others.              | -->
<!-- |                   | I **almost never** feel unhappy because of others.       | -->
<!-- |                   | I **sometimes** feel unhappy because of others.          | -->
<!-- |                   | I **often** feel unhappy because of others.              | -->
<!-- |                   | I **always** feel unhappy because of others.             | -->
<!-- | **Treated**        | People **never** treat me differently.                   | -->
<!-- |                   | People **almost never** treat me differently.            | -->
<!-- |                   | People **sometimes** treat me differently.               | -->
<!-- |                   | People **often** treat me differently.                   | -->
<!-- |                   | People **always** treat me differently.                  | -->
...
```{r}
sd_output('cbc_q9', type = 'question')

sd_output('cbc_q9_w_tired', type = 'question')
sd_output('cbc_q9_w_walking', type = 'question')
sd_output('cbc_q9_w_sports', type = 'question')
sd_output('cbc_q9_w_concentration', type = 'question')
sd_output('cbc_q9_w_embarrassed', type = 'question')
sd_output('cbc_q9_w_unhappiness', type = 'question')
sd_output('cbc_q9_w_treated', type = 'question')
...
```{r}
sd_output('cbc_q10', type = 'question')

sd_output('cbc_q10_w_tired', type = 'question')
sd_output('cbc_q10_w_walking', type = 'question')
sd_output('cbc_q10_w_sports', type = 'question')
sd_output('cbc_q10_w_concentration', type = 'question')
sd_output('cbc_q10_w_embarrassed', type = 'question')
sd_output('cbc_q10_w_unhappiness', type = 'question')
sd_output('cbc_q10_w_treated', type = 'question')
